...
# IMPORTANT: do NOT auto-import all llm adapters here.
# Some adapters (e.g., gemma/phi) may pull in flash-attn and crash if flash-attn/torch are ABI-incompatible.
from . import qwen2  # registers 'qwen2'
from . import qwen3  # registers 'qwen3'
