...
#
# Usage:
#     python eval_cls_head_qwen_sample.py \
...
def load_model(checkpoint_path: str, device: str = "cuda") -> TinyLlavaForConditionalGeneration:
    ...
    model.vision_tower._load_model(
        ...
        pretrained_vision_tower_path="/root/autodl-tmp/Tiny_LLaVA/third_model/NetMamba/finetune_train_out/ISCXVPN2016_npy_v3_balacned_split_train_test_epochs60/checkpoint-best.pth"
    )
